...
#Note this is the ONLY point where you need to declare the states list. you will use this list for all of the following problems
...
#Permanently sort your list in reverse order, printing it out both sorted and unsorted
